# -*- coding: utf-8 -*-
"""
Created on Wed Dec 12 16:24:04 2018
...
class Player:
    ...
    def __init__(self, name, position, standing='normal', money= 10000, playing = True):
        self.name = name
        self.money = money
        self.hand = []
    ...
    def increaseMoney(amount):
        self.money += amount

    def decreaseMoney(amount):
        self.money -= amount
...
#        self.hand = []
    ...
    def valuehand(self, floor):
        ...
        if StraightFlush:
            ...
            #print("Floor: \n", floor)
            return -1
        return priority, innerpri, handtype